...
function listArray() {
  ...
  switch (cellValue) {
    case "Multiple Choice – Single Answer":
      array = valuesInRange('dataMappingQuetions', 'F3:F40' ); //Correct Answer - Single
      break;
    case "Multiple Choice – Multiple Answer":
      array = valuesInRange('dataMappingQuetions', 'G3:G40' ); //Correct Answer - Multiple
      break;
    case "True/False":
      array = valuesInRange('dataMappingQuetions', 'H3:H40' ); //Correct Answer - T/F
      break;
    default:
      array = [''];
  }
